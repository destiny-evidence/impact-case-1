...
subtitle: Documentation of a combined ML and LLM pipeline for screening and annotating
...
documents how we use machine learning (ML) and large language models (LLMs) for two tasks:

- **Relevance screening (in/out)** — deciding whether a bibliographic record
  lies within our system boundaries defining climate and health relevance, at several precision/recall operating points.
  See [](./inout/index.md).
