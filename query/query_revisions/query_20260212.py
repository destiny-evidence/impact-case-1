CLIMATE = {
    ...
    'General climate change': """(
           climat*
        OR "global warming"
        OR "greenhouse effect*"    # alternatives ("greenhouse effect","greenhouse effects")
    )""",
    ...
    # Note: the combination with W/2 (emit* OR emission OR releas* OR mitigat*) is too restrictive.
    'Greenhouse gasses': """(
        (
                "greenhouse gas"
             OR "carbon dioxide"
             ...
             OR "sulfuric acid"
             OR so4* OR sulfate*
             OR "fluorinated gas*"    # alternatives ("fluorinated gas", "fluorinated gases","fluorinated gasses")
             ...
             OR "carbon emissions"
             OR "ghg emissions"
             OR "climate forcer*"     # alternatives ("climate forcer", "climate forcers")
             OR slcf
             OR slcfs
        )
        AND NOT (
