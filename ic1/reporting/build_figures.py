...
from ic1.reporting.loaders import load_taxonomy_prompt_churn, load_taxonomy_runs
from ic1.reporting.plots import plot_iteration_timeline
from ic1.reporting.style import apply_style
...
def main() -> None:
    ...
    ap.add_argument("--domain", choices=["taxonomy", "all"], default="all")
