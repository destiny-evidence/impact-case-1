...
class IsolationForestClassifierConfig(_SklearnClassifierConfig):
    ...
    def params_default(cls, trial: 'Trial | None' = None) -> dict[str, Any]:
        params = {
            ...
            'cls__max_samples': 'auto',
            'cls__contamination': 'auto',
            'cls__max_features': 1.0,
        ...
        if trial is not None:
            ...
            params |= {
                'cls__n_estimators': trial.suggest_int('n_estimators', low=20, high=250),
                'cls__max_features': trial.suggest_float('max_features', low=0.2, high=1.0),
